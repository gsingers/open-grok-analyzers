...
public class MercurialRepository extends Repository {
  ...
  private transient static Logger log = LoggerFactory.getLogger(MercurialRepository.class);
  ...
  public static final String CMD_PROPERTY_KEY =
          "com.grantingersoll.opengrok.history.Mercurial";
  /**
  ...
  public static final String NOFOREST_PROPERTY_KEY =
          "com.grantingersoll.opengrok.history.mercurial.disableForest";
