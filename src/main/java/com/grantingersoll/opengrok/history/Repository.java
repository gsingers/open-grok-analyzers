...
public abstract class Repository extends RepositoryInfo {
  private transient static Logger log = LoggerFactory.getLogger(Repository.class);
    /**
    ...
    History getHistory(File file, String sinceRevision)
        ...
        if (sinceRevision != null) {
            ...
            log.warn("Incremental history retrieval is not implemented for {0}.",
                    getClass().getSimpleName());
            log.warn("Falling back to slower full history retrieval.");
        }
