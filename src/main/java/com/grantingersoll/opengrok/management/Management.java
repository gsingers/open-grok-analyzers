...
public final class Management implements ManagementMBean, MBeanRegistration {
    ...
    private void updateProperties() {
        update = Boolean.valueOf(ogaProperties.getProperty("com.grantingersoll.opengrok.indexer.updatedatabase"));
        noThreads = Integer.valueOf(ogaProperties.getProperty("com.grantingersoll.opengrok.indexer.numberofthreads"));
        configurationFile = ogaProperties.getProperty("com.grantingersoll.opengrok.configuration.file");
        String subfiles = ogaProperties.getProperty("com.grantingersoll.opengrok.indexer.subfiles");
        if (subfiles != null) {
            subFiles = subfiles.split(",");
        }
        publishHost = ogaProperties.getProperty("com.grantingersoll.opengrok.indexer.publishserver.url");
