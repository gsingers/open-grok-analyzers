...
import com.grantingersoll.opengrok.analysis.archive.BZip2AnalyzerFactory;
import com.grantingersoll.opengrok.analysis.archive.GZIPAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.archive.TarAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.archive.ZipAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.c.CAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.data.IgnorantAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.data.ImageAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.document.TroffAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.erlang.ErlangAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.executables.ELFAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.executables.JarAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.executables.JavaClassAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.fortran.FortranAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.golang.GolangAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.haskell.HaskellAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.java.JavaAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.lisp.LispAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.perl.PerlAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.php.PhpAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.plain.PlainAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.plain.XMLAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.python.PythonAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.scala.ScalaAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.sql.PLSQLAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.sql.SQLAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.tcl.TclAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.vb.VBAnalyzerFactory;
import com.grantingersoll.opengrok.configuration.Project;
import com.grantingersoll.opengrok.history.HistoryException;
...
import com.grantingersoll.opengrok.analysis.archive.ZipAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.c.CAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.c.CxxAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.csharp.CSharpAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.data.IgnorantAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.data.ImageAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.document.TroffAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.erlang.ErlangAnalyzerFactory;
...
import com.grantingersoll.opengrok.analysis.haskell.HaskellAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.java.JavaAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.javascript.JavaScriptAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.lisp.LispAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.perl.PerlAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.php.PhpAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.plain.PlainAnalyzerFactory;
...
import com.grantingersoll.opengrok.analysis.python.PythonAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.scala.ScalaAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.clojure.ClojureAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.sh.ShAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.sql.PLSQLAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.sql.SQLAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.tcl.TclAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.uue.UuencodeAnalyzerFactory;
import com.grantingersoll.opengrok.analysis.vb.VBAnalyzerFactory;
import com.grantingersoll.opengrok.configuration.Project;
import com.grantingersoll.opengrok.history.Annotation;
import com.grantingersoll.opengrok.history.HistoryException;
import com.grantingersoll.opengrok.history.HistoryGuru;
import com.grantingersoll.opengrok.history.HistoryReader;
import com.grantingersoll.opengrok.logger.LoggerFactory;
import com.grantingersoll.opengrok.search.QueryBuilder;
import com.grantingersoll.opengrok.web.Util;
        ...
        if (a == null) {
            ...
            for (Map.Entry<String, FileAnalyzerFactory> entry
                ...
                if (sigWithoutBOM != null
                        && entry.getValue().getGenre() == FileAnalyzer.Genre.PLAIN
